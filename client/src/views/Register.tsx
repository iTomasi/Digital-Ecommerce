...
const Register = () => {
    ...
    const handleInputFile = (e: any) => {
        try {
            ...
            if (getFileName.type === "image/jpeg" || getFileName.type === "image/png" || getFileName.type === "image/gif" || getFileName.type === "image/svg+xml") {
    ...
    const sendingDatas = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        if (username.length < 3) return console.log("Your username must contains at less 3 characters")
        ...
        <form className="iw_form" onSubmit={sendingDatas}>
            ...
            <div className="formSection">
                ...
                <div className="inputPassword">
                    ...
                    <i className={showPassword.password ? config.EYE.unhidde : config.EYE.hidde} onClick={handlePassword}></i>
                </div>
            </div>
            ...
            <div className="formSection">
                ...
                <div className="inputPassword">
                    ...
                    <i className={showPassword.confirm_password ? config.EYE.unhidde : config.EYE.hidde} onClick={handlePassword}></i>
                </div>
            </div>
